...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
      ...
      <%if("일반회원".equals(gradeName)){ %>
            ...
            <a class="nav-item nav-link" id="myBoard"><i class="fa fa-keyboard"></i>작성한 게시글</a>
            <a class="nav-item nav-link schedule"><i class="fa fa-calendar"></i>일정</a>
            <a class="nav-item nav-link" id="serviceHistory"><i class="fa fa-credit-card"></i>이용서비스 내역</a>
