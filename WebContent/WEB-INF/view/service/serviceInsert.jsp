              ...
              <div class="bg-light rounded p-4">
				<div class="main-panel">
			        <div class="content-wrapper">
			          <div class="row g-4">
			            <div class="col-sm grid-margin stretch-card" id="select1">
			                <div class="card-body border-bottom" > <!--구역 나눔선-->
			                	<div class="bg-light rounded h-100 p-4" >
						            <h4 class="mb-4">상품정보등록</h4>
						            <form action="<%= request.getContextPath() %>/service/serviceInsert2.do" method="post" enctype="multipart/form-data" >
						                <div class="mb-3">
						                 ...
						                 <div class="mb-3">
						                    ...
						                    <input type="text" class="form-control" id="serviceName"  name="serviceName" required aria-describedby="emailHelp">
						                    <p id="textLengthCheck" class="textLengthCheck">( 0 / 최대 30자 )</p>
						                 ...
						                 <div class="mb-3">
											...
											<input class="form-control" type="file" id="files" name="files"  onchange="readURL(this);"  value="사진선택" required>
						                ...
						                <div class="mb-3">
						                    ...
						                    <textarea class="form-control" id="serviceInfo" required name="serviceInfo" style="height: 150px;"></textarea>
									        ...
									        <div class="mb-3">
									            ...
									            <input type="text" class="form-control" id="servicePrice" name="servicePrice" required aria-describedby="emailHelp">
														...
														<div class="item2" style="overflow : hidden;">
															...
															<ul class="list-group list-group">
								                                <li class="list-group-item bg-transparent">
																	<input class="form-control" readonly type="text" id="zip" name="addr_zip" placeholder="우편번호">
																	<input class="form-control" readonly type="text" id="addr_base" name="addr_base" placeholder="기본주소">
																	<input class="form-control" readonly type="text" id="addr_detail" name="addr_detail" placeholder="동주소">
							        ...
							        <button type="submit" class="btn btn-primary" id="insert">상품 등록 신청</button>
							    </form>
							</div>
	              			</div>
				           </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id="option" data-bs-dismiss="modal">서비스선택</button>
      </div>
    </div>
  </div>
</div>
