...
<%
	...
	String tmp = request.getParameter("boardVo");
			...
			<div class="container-fluid pt-4 px-4">
				<div class="col-sm-12">
					<div class="bg-light rounded h-100 p-4" style="width: 1300px;">
						<form name="boardForm" id="boardForm" action="<%=request.getContextPath()%>/board/Update.do" method="post" enctype="multipart/form-data">
							...
							<input type="hidden" name="boardVo" value="<%=tmp%>">
							<div class="form-floating mb-3">
								<input type="text" class="form-control" id="floatingInput" id="title" name="board_title" placeholder="제목을 입력해주세요." style="width:100%;" value="<%=boardVo.getBoard_title()%>">
								<label for="floatingInput">제목</label>
							</div>
							<div class="form-floating">
                                <textarea class="form-control" placeholder="내용을 입력하세요" id="floatingTextarea" name="board_content" style="width:100%; height: 500px;"><%=boardVo.getBoard_content()%></textarea>
							...
							<input type="submit" id ="btnUpdate" class="btn btn-info" data-dismiss="modal" value = "등록">
						</form>
					</div>
				</div>
			</div>
