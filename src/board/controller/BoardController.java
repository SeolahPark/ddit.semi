...
public class BoardController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(command.equals("/board/setSession.do")) {
			...
			try {
				...
				System.out.println("readComment 오류");
				e.printStackTrace();
			}
	...
	// 게시판 댓글 삭제
	private void deleteComment(HttpServletRequest request, HttpServletResponse response) throws IOException, NumberFormatException, SQLException {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (command.equals("/board/Update.do")) {
			try {
				...
				System.out.println("boardUpdate Post 오류");
				e.printStackTrace();
			}
		} else if (command.equals("/board/Insert.do")) {
			try {
				...
				System.out.println("insertBoard Post 오류");
				e.printStackTrace();
			}
		}else if(command.equals("/board/UpdateComment.do")) {
			try {
				updateComment(request,response);
			} catch (Exception e) {
				System.out.println("updateComment Post 오류");
				e.printStackTrace();
			}
		}
